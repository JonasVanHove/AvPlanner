...
import { calculateUpgradeCost, POINTS_PER_STATUS } from '@/lib/buddy-battle/game-logic';
import { StatType, BuddyStat } from '@/lib/buddy-battle/types';
import { getAuthenticatedUser, createAdminClient, isAdminKeyAvailable } from '@/lib/buddy-battle/server-auth';
